...
class PostViewModel: ViewModel() {
    ...
    fun postData(idpel: String, unit: String, nama: String, alamat: String, noHp: String, tarif: String, daya: String, indikasi: String,
                         stanRek: String, kwhBln1: String, kwhBln2: String, kwhBln3: String, taggingLokasi: String, fotoMeter: String, fotoRumah: String,
                         tindakLanjut: String, stanSurvey: String) {
        ApiClient.instance
            .postDataKarebosi(idpel, unit, nama, alamat, noHp, tarif, daya, indikasi, stanRek, kwhBln1, kwhBln2, kwhBln3,
                taggingLokasi, fotoMeter, fotoRumah, tindakLanjut, stanSurvey)
